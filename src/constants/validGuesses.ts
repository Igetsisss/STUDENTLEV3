...
const JUNIOR = [
  ...
  'tuck', 'amaree', 'phillip', 'maxx', 'betsy', 'sophie', 'cole', 'grant',
  'alexa', 'sammy', 'blair', 'evelyn', 'gracie', 'ayo', 'meriwether',
  'paige', 'ria', 'amelia', 'hannah', 'katlynn', 'teagan', 'beatrice',
  'sarah', 'vance', 'hunter', 'brad', 'tyler', 'greg', 'franklin',
  'braiden', 'annabelle', 'preston', 'maddie', 'tommy', 'collier',
  'colt', 'dean', 'havana', 'matthew', 'lily', 'kade', 'griffin', 'hayes',
  'mose', 'vandy', 'logan', 'scarlett', 'mcvey', 'george', 'chloe',
  'luke', 'layla', 'ryder', 'ray', 'victoria', 'mayomi', 'maya', 'bryce',
  'sienna', 'bobby', 'charlie', 'lilah', 'sean', 'kenzo', 'leah', 'jules',
  'gabby', 'charlotte', 'sasha', 'sophia', 'tanner', 'marley', 'eva',
  'brent', 'chase', 'harley', 'makayla', 'grayson', 'claire', 'chris',
  'munchie', 'nicole'
]
...
if (grade == null) {
  ...
  GRADEWORDS = SENIOR
} else if (grade == '"11"' || grade == '"27"' || grade == '"8"') { // kept "8" logic mapping to current Juniors for backward compatibility
  GRADEWORDS = JUNIOR
