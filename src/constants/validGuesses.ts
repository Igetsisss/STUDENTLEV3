...
const SEVENGRADE = [
  'andrew', 'madison', 'tristen', 'brayden', 'xavier', 'jake', 
  'joseph', 'madeline', 'mary', 'strickland', 'ingrid', 'jackson', 
  'zoe', 'bennett', 'nicholas', 'william', 'cole', 'bailey', 
  'tenzin', 'keith', 'ronan', 'lucas', 'eden', 'bree', 'eva', 
  'vivienne', 'liam', 'jack', 'lane', 'hudson', 'thomas', 
  'perry', 'ryan', 'edward', 'garrett', 'richard', 'gaines', 
  'wyatt', 'emma', 'bryce', 'henry', 'grayden', 'emily', 
  'samuel', 'william', 'laura', 'elizabeth', 'lydia', 'davis', 
  'jay', 'samantha', 'isabella', 'sloane', 'violet', 'sara', 
  'cathryn-rose', 'mary-grace', 'cristiano', 'whitney', 'addison', 
  'ellison', 'charles', 'isabel', 'peighton', 'isabell', 'mary', 
  'julia', 'ryan', 'crosby', 'gemma', 'sophia', 'daniel', 'hugh', 
  'alexa', 'merrick', 'landon', 'connor', 'robert', 'ayden', 
  'emerson', 'caroline', 'lucas', 'lucy', 'turner', 'joshua', 
  'coleman', 'chase', 'ava', 'prakhar', 'mia', 'sovereign', 
  'riley', 'daniel', 'james', 'cole', 'jude', 'sarah', 'madeleine', 
  'molly', 'shane', 'miller', 'presley', 'lucas', 'aubrey', 
  'caroline', 'gailyn', 'logan', 'makenzie', 'william', 'adair', 
  'athena', 'treasure', 'sam', 'colton', 'patrick', 'ryan', 
  'divyalakshmi',
]
