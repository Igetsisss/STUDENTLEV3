...
export const MvpModal = ({
  ...
  return (
    <BaseModal title="🏆 You're the MVP!" isOpen={isOpen} handleClose={handleClose}>
      <div className="relative" style={{ minHeight: '280px', overflow: 'hidden' }}>
        <div
          ref={confettiRef}
        ...
        <div className="relative z-10 py-4 text-center">
          ...
          <p className="mb-4 px-2 text-sm text-gray-700 dark:text-gray-300">
            Based on your <strong>win rate</strong>, <strong>average guesses</strong>, and{' '}
            <strong>consistency</strong> across all your Studentle games, you've
            outperformed every other player at the school.
          </p>
          ...
          <p className="px-2 text-xs italic text-gray-400 dark:text-gray-500">
            The MVP is recalculated from all-time stats. Keep playing to hold the crown — anyone can take it!
          </p>
        </div>
      </div>
    </BaseModal>
