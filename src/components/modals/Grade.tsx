...
export const GradeModal = ({ isOpen, handleClose }: Props) => {
  ...
  return (
    <BaseModal title="What Grade are you in?" isOpen={isOpen} handleClose={handleClose}>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        Since Studenle is not limited to one grade we have to ask you what grade you are in order to give you the correct Studentle
      </p>
      <br></br>
      <form>
        <div className="select">
          ...
          <option value="6" disabled>6th - Out Soon!
            ...
            <option value="7">
              7th - Please Only Use if a Beta Tester
            </option>
