        ...
        <div className="w-full max-w-xs px-4">
          {sent ? (
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3">
              ...
              <input
                type="email"
                className="login-email-input w-full rounded border-2 border-slate-300 bg-white px-4 py-3 text-center text-sm font-semibold tracking-wide text-black focus:border-black focus:outline-none disabled:opacity-50 dark:border-slate-600 dark:bg-slate-800 dark:text-white dark:focus:border-white"
